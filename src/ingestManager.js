import { defaultNdiNixPackage, GStreamerMediaEngine, gstPluginPackages, gstRuntimePackages, ndiToRtmpPipeline, sacramentSlateToRtmpPipeline, switchableNdiSlateToRtmpCommand } from "./gstreamerMediaEngine.js";
import { discoverNdiSources } from "./sourceDiscovery.js";
import { EventEmitter } from "node:events";
export { defaultNdiNixPackage, gstPluginPackages, gstRuntimePackages, ndiToRtmpPipeline, sacramentSlateToRtmpPipeline, switchableNdiSlateToRtmpCommand };
export class IngestManager extends EventEmitter {
    ...
    async resolveRuntimeSource(source) {
        ...
        try {
            ...
            if (!match || match.urlAddress === source.ndi.urlAddress)
                return source;
            return {
                ...source,
                ndi: {
